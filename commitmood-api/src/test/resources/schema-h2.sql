-- =========================
-- DROP TABLES (외래키 순서 고려)
-- =========================

-- 자식 테이블부터 삭제 (외래키 제약조건 때문)

-- 1. FLAGGED_TOKEN (COMMIT_LOG 참조)
DROP TABLE IF EXISTS FLAGGED_TOKEN;

-- 2. COMMIT_ANALYSIS (COMMIT_LOG 참조)
DROP TABLE IF EXISTS COMMIT_ANALYSIS;

-- 3. COMMIT_FILE_CHANGE (COMMIT_LOG 참조)
DROP TABLE IF EXISTS COMMIT_FILE_CHANGE;

-- 4. COMMIT_LOG (GITHUB_REPOSITORY, USER_ACCOUNT 참조)
DROP TABLE IF EXISTS COMMIT_LOG;

-- 5. GITHUB_REPOSITORY (USER_ACCOUNT 참조)
DROP TABLE IF EXISTS GITHUB_REPO;

-- 6. ACCESS_TOKEN (USER_ACCOUNT 참조)
DROP TABLE IF EXISTS ACCESS_TOKEN;

-- 7. USER_ACCOUNT (최상위 테이블)
DROP TABLE IF EXISTS USER_ACCOUNT;

-- Spring Batch Meta-Data Tables for H2 Database
